...
from cvmvcf.model import _Call, _Record, make_calldata_tuple
from cvmvcf.model import _Substitution, _Breakend, _SingleBreakend, _SV
...
class _vcf_metadata_parser(object):
    ...
    def vcf_field_count(self, num_str):
        """Cast khvcf header numbers to integer or None"""
        if num_str is None:
            return None
...
class Reader(object):
    ...
    def _map(self, func, iterable, bad=None):
